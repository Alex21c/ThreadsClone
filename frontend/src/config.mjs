const API_ENDPOINTS = {
  "User": {
    ...
    "get-all-the-users-except-current-one" : "/api/v1/user/get-all-the-users-except-current-one?howManyUsers=100"  
  },
  "Search":{
    "get-all-users-or-threads-matching-search-query": "/api/v1/search/get-all-users-or-threads-matching-search-query"
  },
  "Thread": {
    ...
    'get-all-the-threads-created-by-specific-user': "/api/v1/thread/get-all-the-threads-created-by-specific-user",
  ...
  "Reply":{
    ...
    "get-all-the-replies-made-by-specific-user": "/api/v1/reply/get-all-the-replies-made-by-specific-user",
