...
import muiModalEditProfileReducer from "./Slices/muiModalEditProfile.mjs";
export const store = configureStore({
  reducer: {
    theme: themeReducer,
    muiModalHavingQrCodeForAppDownload:
      muiModalHavingQrCodeForAppDownloadSliceReducer,
    muiModalCreateNewThread: muiModalCreateNewThreadSliceReducer,
    muiModalCreateNewReply: muiModalCreateNewReplySliceReducer,
    muiModalEditProfile: muiModalEditProfileReducer,
