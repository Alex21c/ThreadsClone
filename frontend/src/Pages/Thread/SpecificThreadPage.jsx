...
export default function SpecificThreadPage(){
  ...
  return (
    <div className="flex " style={{backgroundColor: theme.background, color: theme.primaryText}}>
      ...
      <main 
        style={{ backgroundColor: theme.backgroundHover, borderColor: theme.borderColor, color: theme.primaryText}}
        ...
        <div className="flex flex-col items-center gap-[1rem] w-[100%] ">
          ...
          
          {
            ...
            <Thread isItSpecificThreadPage={true} threadData={threads.specificThread} totalItems={1} idx={0}/>
          }
