  ...
  return (
    <div className='flex flex-col items-center gap-[1rem]' style={{color: theme.secondaryText}}>
      ...
      <form className='flex flex-col gap-[.5rem]'>
        <input type="text" placeholder='Username, phone or email' className='bg-[#1e1e1e] p-[1rem] rounded-md w-[20rem] outline-none focus:border-[#f3f5f726] border border-transparent focus:text-[#f3f5f7] transition' />
        <input type="password" placeholder='Password' className='bg-[#1e1e1e] p-[1rem] rounded-md w-[20rem] outline-none focus:border-[#f3f5f726] border border-transparent focus:text-[#f3f5f7] transition' />
