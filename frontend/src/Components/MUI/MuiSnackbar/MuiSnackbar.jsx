...
export default function MuiSnackbar({type, message}){
  ...
  return (
    <Snackbar  open={muiSnackbar.open} autoHideDuration={ Number(process.env.REACT_APP_HIDE_SNACKBAR_AFTER_N_MILLISECONDS)} onClose={()=>dispatch(closeTheMuiSnackbar())}  anchorOrigin={{vertical,horizontal} } >
