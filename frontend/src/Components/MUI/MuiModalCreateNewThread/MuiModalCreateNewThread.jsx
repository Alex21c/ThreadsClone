...
import {
  openTheMuiSnackbar,
  closeTheMuiSnackbar,
} from "../../../Redux/Slices/muiSnackbarSlice.mjs";
...
export default function MuiModalCreateNewThread() {
  ...
  async function handleReqCreateANewPost() {
    ...
    if (bodyImage === null && bodyText === "") {
      return dispatch(
        openTheMuiSnackbar({
          message: "Kindly provide either any text or image as thread!",
          type: "info",
        })
      );
    }
    ...
    try {
      ...
      dispatch(
        openTheMuiSnackbar({
          message: "Unable to Post a Thread, please try again after some time!",
          type: "error",
        })
      );
    } finally {
        ...
        >
          ...
          <div className="flex gap-[2rem]">
            ...
            <div className="w-[90%] flex flex-col gap-[1rem]">
              <h3 className="font-medium" style={{ color: theme.primaryText }}>
              ...
              {statePreviewImageSrc !== "" ? (
                <div className="relative">
                  <i
                    className="cursor-pointer absolute right-[.5rem] top-[.5rem] fa-sharp fa-regular fa-xmark text-[1rem] text-white py-[.2rem] px-[.7rem] rounded-full bg-black hover:bg-white transition hover:text-black"
                    onClick={(event) => {
                      handleXBtnClick(event);
                    }}
                  ></i>
                  <img
                    ref={refImageUploadByUser}
              ...
              {statePosting ? (
                ...
                <button
                  ...
                  onClick={() => handleReqCreateANewPost()}
                >
                  Post
                </button>
              )}
